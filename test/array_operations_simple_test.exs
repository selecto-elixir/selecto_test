defmodule ArrayOperationsSimpleTest do
  ...
  describe "Array Aggregation Operations" do
    test "array_agg generates correct SQL" do
      ...
      # Build SQL
      {sql_iodata, _params} = Selecto.Builder.ArrayOperations.build_array_sql(array_spec, [])
  ...
  describe "Array Filter Operations" do
    test "array_contains filter" do
      ...
      {sql_iodata, _params} = Selecto.Builder.ArrayOperations.build_array_sql(filter_spec, [], selecto)
  ...
  describe "Array Size Operations" do
    test "array_length operation" do
      ...
      # Build SQL
      {sql_iodata, _params} = Selecto.Builder.ArrayOperations.build_array_sql(size_spec, [])
